...
setwd("/Users/vmeyennf/Desktop/CheeAnalysis/")

RNAseqfileName <- "H9_RNASeq_D0vsD10.txt"
RNAseqdatasetRAW <- read.csv(RNAseqfileName,sep="\t",header=TRUE,skip=0,fill=TRUE,dec = ".",as.is=T)

RNAseqdataset <- RNAseqdatasetRAW[,c(1,13,15:ncol(RNAseqdatasetRAW))]

RNAseqdataset <- cbind(RNAseqdataset, D0mean = rowMeans(RNAseqdataset[,7:9]), D10mean = rowMeans(RNAseqdataset[,10:12]))
