...
#mat_data_group<-cbind(mat_data,groups)
#x1<- subset(mat_data_group, groups==1)
#x2<- subset(mat_data_group, groups==2)
#x3<- subset(mat_data_group, groups==3)
#x4<- subset(mat_data_group, groups==4)
...
heatmap.2(mat_data,
          ...
          dendrogram = "both",     # only draw a row or col dendrogram
          scale = "row",
          Colv=F,Rowv=T,
