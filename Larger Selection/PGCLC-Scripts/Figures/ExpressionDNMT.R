...
setwd("~/Dropbox/Manuscripts/PGCLC/Figures/Figure2/DNMT_Expression")

#Human DataSets 
fileName <- "humExpression.csv"

#Mouse DataSets
#fileName <- "musExpression.csv"
...
#pdf (paste(fileName,"DNMTs.pdf"), width = 10, height = 10, useDingbats=FALSE,colormodel='rgb')
