...
setwd("/Users/meyennf/Documents/Cambridge/Projects/hESC/Guo_2/_FinalFigures/HeatMap/")

filenameRAW <- "Values.txt"
...
Imprints <- Imprints[,c(1,4:ncol(Imprints))]

names(Imprints) <- c("Type","ICM Guo et al. 2014","HNES1 Guo et al. 2016","HNES1 (primed) Guo et al. 2016","Shef6-EOS (primed)","Shef6-EOS (CR p5)","Shef6-EOS (CR p9)","Shef6-EOS (CR LT)","H9-NK2 (primed) Takashima et al. 2014","H9-NK2 (reset) Takashima et al. 2014")
...
heatmap.2(mat_data,
          ...
          dendrogram = "none",     # only draw a row or col dendrogram
 #         scale = "col",
          Colv=F,Rowv=F,
