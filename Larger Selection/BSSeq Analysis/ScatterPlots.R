setwd("~/Documents/Cambridge/Collaborations/Austin Smith/2015Oct/Scatter/")
txt.files <- list.files(pattern="*.txt") 
for (txtfile in txt.files) {
...
names(data) <- c("Chromosome","ICM (Guo)","ICM (Smith)","naive H9 (Takashima)","primed H9 (Takashima)","primed (Gafni)","naive (Gafni) d12", "naive (Gafni) d17")
